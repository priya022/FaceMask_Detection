...
faceNet = cv2.dnn.readNet("facemask_detectapp//face_detector//deploy.prototxt",
                          "facemask_detectapp//face_detector//res10_300x300_ssd_iter_140000.caffemodel")
...
def main(image_data):
    ...
    print(image_data, 'image data from views')
